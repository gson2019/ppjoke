package com.example.bubble.libnavcompiler;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.example.bubble.libnavannotation.ActivityDestination;
import com.example.bubble.libnavannotation.FragmentDestination;
...
@SupportedAnnotationTypes({"com.example.bubble.libnavannotation.FragmentDestination", "com.example.bubble.libnavannotation.ActivityDestination"})
    ...
    private void handleDestination(Set<? extends Element> elements, Class<? extends Annotation> annotationClass, HashMap<String, JSONObject> destMap) {
        for(Element element : elements){
            ...
            if(destMap.containsKey(pageUrl)){
                messager.printMessage(Diagnostic.Kind.ERROR, "Different page can not use same pageUrl");
            }else{
